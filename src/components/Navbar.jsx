...
const Navbar = () => {
  ...
  return (
    <div className="flex items-center bg-[#cdcfc666] p-1">
      ...
      <button onClick={hideSidebar}className="p-4 absolute navbar-button-2  invisible">X</button>
      <div className="flex justify-start flex-1 font-">
      <img className="w-14 h-[63px] border-[1px] border-[#00000047] rounded-full" src={currentUser.photoURL} />
      </div>
      <div className='flex  justify-end flex-1 items-center'>
        <span className="pr-3">{currentUser.displayName}</span>
